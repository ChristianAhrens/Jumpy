...
// Placeholder test to prove the Jumpy test pipeline (Projucer export, build,
// execution, CI gating) end-to-end. Replace/extend with real coverage of
// Jumpy's logic as it gets extracted into testable, JUCE-UI-independent units.
...
{
public:
    SanityTest() : juce::UnitTest ("Sanity", "Jumpy") {}
