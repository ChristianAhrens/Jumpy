...
JucerProjectPath=Jumpy.jucer
XCodeProjectPath=Builds/MacOSX/Jumpy.xcodeproj
...
# Jumpy.jucer's Release config with ad-hoc signing -- CODE_SIGNING_ALLOWED=NO alone does not
