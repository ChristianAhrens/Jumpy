...
if "%VSVER%"=="VS2022" (
    ...
    set BUILDSLN=%WORKSPACE%\Builds\VisualStudio2022\Jumpy.sln
) else (
    ...
    set BUILDSLN=%WORKSPACE%\Builds\VisualStudio2026\Jumpy.sln
)
...
"%PROJUCERVSDIR%\x64\Release\App\Projucer.exe" --resave %WORKSPACE%\Jumpy.jucer --fix-missing-dependencies
echo.
